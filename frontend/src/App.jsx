    ...
    <div className="flex items-center justify-between px-4 py-6 bg-white border-t border-gray-200 mt-6 rounded-lg shadow-sm">
        <div className="flex justify-between w-full">
            <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-300 ${paginationPage <= 1 || loading
            ...
            <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-300 ${paginationPage >= totalPages || loading
                    ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                    : 'bg-gray-200 text-gray-700 hover:bg-gray-600 hover:text-white hover:shadow-lg'
                    }`}
            >
                            ...
                            {highlightsShowFilterDropdown && (
                                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 text-sm transition-all duration-300 ${!highlightsFilterHelpers.hasActiveFilters()
                                            ? 'bg-blue-50 text-blue-700 font-medium'
                                    ...
                                    {HIGHLIGHTS_FILTERS.map(filter => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2 text-sm transition-all duration-300 flex items-center gap-3 ${isActive
                                                    ? 'bg-blue-50 text-blue-700 font-medium'
                                                    : 'text-gray-700 hover:bg-gray-100'
                                                    }`}
                                            >
                            ...
                            <div className="flex items-start justify-between px-3 sm:px-4 pt-3 sm:pt-4 pb-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        <ChevronDown
                                            size={20}
                                            className={`text-gray-500 transition-transform duration-200 ${highlightsHandlers.isOrderExpanded(order) ? 'rotate-180' : ''
                                                }`}
                                        />
                                    </button>
                                </div>
                            ...
                            {showFilterDropdown && (
                                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 text-sm transition-all duration-300 ${!activeFilter
                                            ? 'bg-blue-50 text-blue-700 font-medium'
                                            : 'text-gray-700 hover:bg-gray-100'
                                            }`}
                                    >
                        ...
                        {isFetchExpanded && (
                            <div className="p-6">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        <button
                                            ...
                                            className={`px-4 py-2 text-sm rounded-md transform hover:scale-105 transition-all duration-300 shadow-sm hover:shadow-md font-medium ${fetchingData
                                ...
                                <button
                                    ...
                                    disabled={fetchingData}
                                    className={`w-full px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center justify-center gap-2 ${fetchingData
                                        ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                            ...
                                            <div className="flex items-start justify-between px-3 sm:px-4 pt-3 sm:pt-4 pb-2">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button
                                                        ...
                                                        className={`p-2 rounded-md transition-all duration-300 ${stableHandlers.isItemHighlighted(order)
                                                    ...
                                                    >
                                                        <ChevronDown
                                                            size={20}
                                                            className={`text-gray-500 transition-transform duration-200 ${stableHandlers.isOrderExpanded(order) ? 'rotate-180' : ''
                                                                }`}
                                                        />
                                                    </button>
                                                </div>
                                    ...
                                    {!showClearWarning ? (
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                disabled={clearingDatabase}
                                                className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-300 flex items-center gap-2 ${clearingDatabase
                                                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                                    : 'bg-red-600 text-white hover:bg-red-700'
                                                    }`}
                                            >
                            ...
                            {showFilterDropdown && (
                                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                                    <button
                                        ...
                                        className={`w-full text-left px-4 py-2 text-sm transition-all duration-300 ${!stateActiveFilter
                                            ? 'bg-blue-50 text-blue-700 font-medium'
                                            : 'text-gray-700 hover:bg-gray-100'
                                            }`}
                                    >
    ...
    return (
        <div className="fixed bottom-4 left-4 bg-white border-2 border-red-500 rounded-lg p-4 max-w-md z-50">
            ...
            <button
                ...
                className={`w-full py-2 px-4 rounded ${isDebugging
