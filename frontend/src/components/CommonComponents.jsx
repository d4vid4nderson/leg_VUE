...
export const CategoryTag = ({ category }) => {
  ...
  if (!filter) {
    return (
      <span className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 dark:text-gray-300 text-xs font-medium rounded-full">
        <ScrollText size={12} />
        <span>Unknown</span>
      </span>
    );
  ...
  const getPillStyles = (cat) => {
    switch (cat) {
      ...
      default:
        return 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 dark:text-gray-300';
    }
  };
...
export const Pagination = ({
  ...
  <div className="flex items-center justify-between px-4 py-6 bg-white dark:bg-dark-bg-secondary border-t border-gray-200 dark:border-dark-border mt-6 rounded-lg shadow-sm">
      ...
      <button
        ...
        className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-300 ${
          paginationPage <= 1 || loading
            ? 'bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-500 dark:text-gray-400 cursor-not-allowed'
            : 'bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-200 hover:bg-gray-600 dark:hover:bg-gray-500 hover:text-white hover:shadow-lg'
        }`}
      >
        Previous
      </button>
      <div className="flex items-center text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">
        <span>Page</span>
...
export const InformationModal = ({ isOpen, onClose }) => {
  ...
  const renderGettingStarted = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6">
        ...
        <div className="bg-white dark:bg-dark-bg-secondary rounded-md p-4 border border-blue-100 dark:border-blue-700">
      ...
      <div className="bg-white dark:bg-dark-bg-secondary border border-gray-200 dark:border-dark-border rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">Fetch Executive Orders</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">Visit the Executive Orders page → Use the "Fetch Fresh Data" section → Select a date range → Click "Fetch Executive Orders"</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">Explore State Legislation</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">Choose a state from the menu → Use "Fetch Fresh Data" → Search by topic or fetch the latest bills → AI analysis included</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">Save Your Favorites</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">Click the star icon on any item to save it to your highlights → Access all starred items from the Highlights page</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">Use AI Analysis</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">Every item includes AI-generated summaries, key points, and business impact analysis → Copy reports or download for sharing</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          {Object.entries(SUPPORTED_STATES).map(([state, abbr]) => (
            <div key={abbr} className="flex items-center justify-between p-2 bg-gray-50 rounded text-sm">
              <span>{state}</span>
              <span className="text-gray-500 dark:text-gray-400 font-mono">{abbr}</span>
            </div>
          ))}
        </div>
      ...
      <div className="bg-white dark:bg-dark-bg-secondary border border-gray-200 dark:border-dark-border rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <h5 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Update Frequency</h5>
          ...
          <div>
            <h5 className="font-medium text-gray-700 dark:text-gray-300 mb-2">Data Accuracy</h5>
            <ul className="space-y-1 text-gray-600 dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800 dark:text-gray-200">Executive Order Tracking</h5>
                <p className="text-sm text-gray-600 dark:text-gray-400">Real-time federal executive order monitoring with custom date ranges</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800 dark:text-gray-200">State Legislation Analysis</h5>
                <p className="text-sm text-gray-600 dark:text-gray-400">Multi-state bill tracking with topic-based search capabilities</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800 dark:text-gray-200">AI-Powered Analysis</h5>
                <p className="text-sm text-gray-600 dark:text-gray-400">Automated summaries, talking points, and impact assessments</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800 dark:text-gray-200">Highlights & Bookmarks</h5>
                <p className="text-sm text-gray-600 dark:text-gray-400">Save important items for quick access across all pages</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800 dark:text-gray-200">Advanced Search & Filtering</h5>
                <p className="text-sm text-gray-600 dark:text-gray-400">Filter by category, state, date, and search across all content</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-800 dark:text-gray-200">Export & Sharing</h5>
                <p className="text-sm text-gray-600 dark:text-gray-400">Copy reports, download documents, and share analysis</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-dark-bg-secondary border border-gray-200 dark:border-dark-border rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Real-time Data</h5>
            <p className="text-sm text-gray-600 dark:text-gray-400">Live data fetching from official government APIs</p>
          </div>
          
          <div className="bg-gray-50 p-4 rounded-lg">
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Cloud Database</h5>
            <p className="text-sm text-gray-600 dark:text-gray-400">Azure SQL with automatic backups and scaling</p>
          </div>
          
          <div className="bg-gray-50 p-4 rounded-lg">
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Responsive Design</h5>
            <p className="text-sm text-gray-600 dark:text-gray-400">Works on desktop, tablet, and mobile devices</p>
          </div>
        </div>
      </div>
  ...
  const renderSupport = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-dark-bg-secondary border border-gray-200 dark:border-dark-border rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="border-b border-gray-100 pb-4">
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">How often is the data updated?</h5>
          ...
          <div className="border-b border-gray-100 pb-4">
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Can I export the AI analysis?</h5>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="border-b border-gray-100 pb-4">
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">How accurate is the AI analysis?</h5>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Can I request additional states?</h5>
            <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <div className="bg-white dark:bg-dark-bg-secondary border border-gray-200 dark:border-dark-border rounded-lg p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <Monitor size={16} className="text-gray-500 dark:text-gray-400 mt-1" />
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">System Requirements</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-start gap-3">
            <Shield size={16} className="text-gray-500 dark:text-gray-400 mt-1" />
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">Data Security</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h5 className="font-medium text-gray-800 dark:text-gray-200">Service Status</h5>
              <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <div className="bg-gradient-to-r from-gray-50 to-blue-50 border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex items-center gap-4 text-gray-600 dark:text-gray-400">
            <span>📧 david4nderson@pm.me</span>
            <span>🌐 legislationvue.com</span>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-dark-bg rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        {/* Modal Header */}
        <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-dark-border">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 dark:text-gray-200 flex items-center gap-2">
            <Info size={24} className="text-blue-600" />
            Help & Information
          </h2>
          <button
            onClick={onClose}
            className="text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200"
          >
            <XIcon size={24} />
          </button>
        </div>
        ...
        <div className="flex justify-between items-center p-6 border-t border-gray-200 dark:border-dark-border">
          <div className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">
            ...
            <a href="mailto:david4nderson@pm.me" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
              david4nderson@pm.me
            </a>
          </div>
          <button
            onClick={onClose}
            className="px-6 py-2 bg-gray-600 dark:bg-gray-700 text-white rounded-md hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors duration-200"
          >
            Close
          </button>
        </div>
