...
const ExecutiveOrderSkeleton = () => {
  return (
    <div className="border rounded-lg overflow-hidden transition-all duration-300 border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-bg-secondary animate-pulse">
      <div className="p-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4 gap-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-3 mb-3">
              ...
              {/* Bottom Row - Category and Status Tags */}
        ...
        {/* AI Summary skeleton */}
        <div className="mb-6">
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border border-purple-200 dark:border-purple-700 rounded-lg p-5">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-purple-300 dark:bg-purple-600 rounded-full"></div>
                <div className="h-6 bg-purple-200 dark:bg-purple-700 rounded-md w-48"></div>
              </div>
              <div className="h-5 bg-purple-300 dark:bg-purple-600 rounded-md w-24"></div>
            </div>
