...
// Git-based version info injected at build time
...
const Footer = ({ appVersion }) => {
  ...
  const handleSupportClick = () => {
    window.location.href = 'mailto:david4nderson@pm.me?subject=LegislationVUE Support Request';
  };
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6 md:pt-10 pb-12 md:pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-start w-full">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-2 break-words flex items-center gap-1">
              <style>
                {`
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-2 break-words">
              All rights reserved. Version: <span className="font-mono">{displayVersion}</span>
              {gitCommit !== 'dev' && gitCommit !== 'unknown' && (
                <span className="ml-2">({formatBuildDate(buildTimestamp)})</span>
              )}
            </p>
          </div>
          ...
          <div className="flex flex-col items-start md:items-end w-full">
            ...
            <div className="flex flex-col space-y-2 items-start md:items-end w-full">
              ...
              {/* Support Link */}
              <a
                href="mailto:david4nderson@pm.me?subject=LegislationVUE Support Request"
                onClick={(e) => {
                  e.preventDefault();
                  handleSupportClick();
                }}
