    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4 relative">
        ...
        <button
          ...
          className="absolute top-4 right-4 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors p-1 z-10"
        ...
        <div className="text-center pt-8 pb-6 px-6">
          <div className="bg-yellow-100 dark:bg-yellow-900/20 p-3 rounded-full inline-flex mb-4">
            <Scale size={24} className="text-yellow-600 dark:text-yellow-500" />
          </div>
