...
const SessionFilter = ({ 
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && !disabled && (
        <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-[120] w-max min-w-[480px] max-w-[600px] max-h-[400px] overflow-hidden">
